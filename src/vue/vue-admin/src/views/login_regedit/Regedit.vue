    ...
    <div style="width: 500px; height: 400px; background-color: white; border-radius: 10px; margin: 150px auto; padding: 50px;">
      ...
      <el-form ref="loginForm" :model="user">
        ...
        <el-form-item prop="checkpassword">
          <el-input type="checkpassword" placeholder="再次输入密码" prefix-icon="el-icon-user" size="medium"></el-input>
        </el-form-item>
        <el-form-item>
          <div style="display: flex">
            <el-input prefix-icon="el-icon-circle-check" placeholder="请输入验证码" size="medium" style="flex: 1"></el-input>
            <div style="flex: 1">
